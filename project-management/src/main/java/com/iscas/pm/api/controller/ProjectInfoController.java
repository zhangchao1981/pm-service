...
public class ProjectInfoController {
    ...
    public Project editProject(@RequestBody Project project) {
        if(project.getStatus() == ProjectStatusEnum.CLOSED){
            throw new IllegalArgumentException("该项目处于关闭状态，不能修改");
        }
    ...
    @PreAuthorize("hasAuthority('/projectInfoService/closeProject')")
